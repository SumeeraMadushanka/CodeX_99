    ...
    <>
      <div className="bg-slate-200" id="services">
        <div className="text-center pt-16 translate-y-8 md:translate-y-20">
          <span className="text-5xl text-black font-semibold">What Do We Do?</span>
        </div>
        <div className="container  mx-auto p-10 md:p-36 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-3">
          ...
          <div className=" hover:bg-violet-600 overflow-hidden shadow-lg outline outline-violet-600 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100 duration-300 scale-90">
          ...
          <div className=" hover:bg-pink-600 1overflow-hidden shadow-lg outline outline-pink-600 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-100 duration-300 scale-90">
