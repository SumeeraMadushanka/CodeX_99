        ...
        <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mt-4 space-y-4">
              ...
              <li>
                <span className="text-gray-600 hover:text-gray-800">Analytics</span>
              </li>
              <li>
                <span className="text-gray-600 hover:text-gray-800">Commerce</span>
              </li>
              <li>
                <span className="text-gray-600 hover:text-gray-800">Insights</span>
              </li>
            </nav>
          </div>
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mt-4 space-y-4">
              ...
              <li>
                <span className="text-gray-600 hover:text-gray-800">Documentation</span>
              </li>
              <li>
                <span className="text-gray-600 hover:text-gray-800">Guides</span>
              </li>
              <li>
                <span class="text-gray-600 hover:text-gray-800">API Status</span>
              </li>
            </nav>
          </div>
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mt-4 space-y-4">
              ...
              <li>
                <span className="text-gray-600 hover:text-gray-800">Jobs</span>
              </li>
              <li>
                <span className="text-gray-600 hover:text-gray-800">Partners</span>
              </li>
            </nav>
          </div>
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mt-4 space-y-4">
              ...
              <li>
                <span className="text-gray-600 hover:text-gray-800">Privacy</span>
              </li>
              <li>
                <span className="text-gray-600 hover:text-gray-800">Terms</span>
              </li>
            </nav>
          </div>
        </div>
